...
def download_from_drive(file_id, dest_path):
    ...
    #st.code(d)
    print(repr(os.environ["GOOGLE_SERVICE_ACCOUNT_JSON"].strip().encode('unicode_escape').decode('utf-8')), flush=True)
    e = json.loads(os.environ["GOOGLE_SERVICE_ACCOUNT_JSON"].encode('unicode_escape').decode('utf-8'))
